...
float HP_Coeffs [] = {-0.0000023507603079654576, 0.99999529847938406, -0.0000023507603079654576};
float LP_Coeffs [] = {0.32642577049668625, 0.3471484590066275 , 0.32642577049668625};
float NOTCH_Coeffs [] = {-0.0000047015983214016115,  1.0000094031966427, -0.0000047015983214016115};

float adc_readings [3];
int i = 0;
